...
export default function Home() {
  ...
  // Services from shared data (linked to /service/[slug] pages)
  const pastProjects: PastProject[] = [
    ...
    { id: "project-5", image: "https://i.imgur.com/n14I2D4.jpeg", title: "Commercial Exterior", location: "Wayne, NJ" },
    ...
    { id: "project-9", image: "https://i.imgur.com/4c1vAQI.jpeg", title: "Hallway Painting", location: "Colts Neck, NJ" },
    ...
    { id: "project-13", image: "https://i.imgur.com/Bkh6jte.jpeg", title: "Sam's Painting Crew", location: "Wayne, NJ" },
    ...
    { id: "project-16", image: "https://i.imgur.com/Vyuh1We.jpeg", title: "Cabinet Painting", location: "Hardyston, NJ" },
    { id: "project-17", image: "https://i.imgur.com/Eo4XMUh.jpeg", title: "Staircase & Foyer", location: "Hardwick, NJ" },
  ];
        ...
        <section id="past-work" className="py-24 bg-neutral-100/30 transition-colors duration-300 overflow-hidden">
          <div className="max-w-7xl mx-auto px-4 sm:px-8 mb-12">
            <div className="space-y-3 text-center lg:text-left">
              ...
              <p className="text-sm max-w-2xl text-neutral-600 font-normal leading-relaxed">
                Take a look at real painting projects completed by Sam&apos;s Painting across New Jersey. See interior painting, exterior painting, cabinet painting, staining, and more.
              </p>
            </div>
          </div>
