...
export const metadata: Metadata = buildPageMetadata({
  ...
  description:
    "Interior painting, exterior painting, cabinet painting, deck staining, epoxy floors, and commercial painting in Franklin Lakes and Bergen County. Free estimates. Call (201) 903-2872.",
});
